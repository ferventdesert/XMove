...
u8 HMC5883LShowData()
{
	...
	ComY=HMC5883LDataProcess(myMEMSData[HMC5883DF+4],myMEMSData[HMC5883DF+5]);
	return 1;
}
void InitAllSensor()
{
	...
	isAccExisted=1;
	isComExisted=1;
	setbit(myMEMSData[NODEABILITYDF],BIT6);  //GYRO
	setbit(myMEMSData[NODEABILITYDF],BIT5);  //COM
