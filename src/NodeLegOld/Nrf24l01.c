...
/////妈妈的，本来不想用这么多宏定义的，无所谓了
#define nRF24L01_CE BIT7//P2.4
#define nRF24L01_CSN BIT0//P2.5

#define nRF24L01_SCK BIT3//P2.6
#define nRF24L01_MOSI BIT1//P3.3
#define nRF24L01_MISO BIT2//P3.7
#define nRF24L01_IRQ BIT7//P3.6

//
//
#define nRF24L01_CE_DIR P2DIR
#define nRF24L01_CSN_DIR P3DIR
...
#define nRF24L01_CSN_OutPort P3OUT
...
__interrupt void Port_1(void)
{
  ///进入接收环节
		...
		if((nRF24L01_IRQ_InPort&nRF24L01_IRQ)!=nRF24L01_IRQ)//如果有无线数据
		{
			...
			nRF24L01_Read_Rx_Payload(myReceiveBuff);//读取数据，数据内容可以在Debug 状态小查看
			nRF24L01_Flush_RX_FIFO();
                         ProcessCallBackData();
